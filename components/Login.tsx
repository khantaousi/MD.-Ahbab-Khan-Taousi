...
const Login: React.FC<LoginProps> = ({ onLogin, lang, t }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
      <div className="max-w-md w-full glass p-10 rounded-[40px] border border-white/5 shadow-[0_35px_60px_-15px_rgba(0,0,0,0.5)]">
        <div className="text-center mb-10">
          <div className="bg-cyan-600 w-20 h-20 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-cyan-500/20 rotate-3 group hover:rotate-0 transition-transform duration-500">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-slate-900 border border-white/5 rounded-2xl py-4 pl-12 pr-4 focus:border-cyan-500/50 focus:outline-none transition-all font-bold placeholder:text-slate-700"
                placeholder="ID"
                required
              />
            </div>
          ...
          <button
            type="submit"
            className="w-full bg-cyan-600 hover:bg-cyan-500 text-slate-950 font-black py-4 rounded-2xl transition-all shadow-xl shadow-cyan-900/20 flex items-center justify-center gap-3 uppercase tracking-widest text-sm active:scale-[0.98]"
          >
        ...
        <div className="mt-12 pt-8 border-t border-white/5 text-center">
            <Link to="/" className="inline-flex items-center gap-2 text-slate-500 hover:text-cyan-400 transition-colors text-xs font-bold uppercase tracking-widest group">
