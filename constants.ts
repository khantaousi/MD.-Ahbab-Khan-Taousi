...
export const TRANSLATIONS = {
  en: {
    ...
    loginPassPlaceholder: "Enter Secure Password",
    ...
    syncLoading: "Welcome Ahbab's Profile...",
  ...
  bn: {
    ...
    loginEmailPlaceholder: "অ্যাডমিন ইমেইল দিন",
    loginPassPlaceholder: "সিকিউর পাসওয়ার্ড দিন",
